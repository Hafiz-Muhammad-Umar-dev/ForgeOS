...
const (
	...
	TypePlanStarted         EventType = "plan.started"
	TypeNodeStatus          EventType = "node.status"
	TypeNodeFailed          EventType = "node.failed"
	...
	TypeExecutionPaused     EventType = "execution.paused"
	TypeExecutionResumed    EventType = "execution.resumed"
	TypeExecutionEvent      EventType = "execution.event"
)
